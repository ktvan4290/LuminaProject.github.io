...
const HEADSET_PRESETS_LIST = [
  ...
  },
  {
    ...
    desc:"노이즈 캔슬링 헤드폰 최적화. ANC 저역 손실 보상 (클리핑 방지 레벨).",
    bands: makeBands([ 2.5, 3.0, 3.5, 3.5, 2.0, 0.5, 0.0,-0.5,-0.5, 0.0, 0.5, 1.5, 1.5, 2.0, 1.5])
  },
  {
    name:"Hip-Hop & R&B", color:"#9966FF",
    desc:"서브베이스 확장 + 보컬 따뜻함. 힙합, R&B, 트랩.",
    bands: makeBands([ 6.0, 5.5, 5.0, 4.0, 2.5, 1.0, 0.0,-0.5,-1.0, 0.0, 0.5, 1.5, 2.0, 1.0, 0.0])
  },
  customPreset,
];
